...
<head>
    ...
    <meta name="csrf-token" content="lP0pvPhL4uvRamy8hK7AK0S3owshPrWfjYROYfff" />
        ...
        <div class="webinars-list-global-container">
            ...
            <div class="row">
                <div class="small-12 columns" style="text-align:center;">
                    <p class="user-notification-content" style="font-size: 1.2rem;">Для доступа к вебинарам необходимо пройти <a class="nowebinar-link" href="/">регистрацию</a>.</p>
                </div>
            </div>
        </div>
    </section>
